...
CODEX_DELEGATION_GUIDANCE = (
    ...
    "\n"
    "If the `spec-kit-superpowers-bridge` skill is available and the task "
    "mentions Spec Kit, speckit, SDD, `.specify`, or an active `specs/NNN-*` "
    "feature, load it before `codex-delegate`. Use it as the orchestration "
    "layer: preserve Spec Kit artifacts, pass active constitution/spec/plan/"
    "tasks/checklists into the Codex packet, and reconcile implementation "
    "evidence back to those artifacts.\n"
    "\n"
